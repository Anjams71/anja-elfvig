        ...
        <div>
          ...
          <aside id="colorlib-aside" className="border js-fullheight">
            <div className="text-center">
              ...
              <h1 id="colorlib-logo"><a href="index.html">ANJA ELFVING</a></h1>
              <span className="email"><i className="icon-mail"></i>ANJAMS71@GMAIL.COM</span>
            </div>
            <nav id="colorlib-main-menu" role="navigation" className="navbar">
              <div id="navbar" className="collapse">
                <ul>
                  ...
                  <li><a href="#education" data-nav-section="education">Uddannelse</a></li>
